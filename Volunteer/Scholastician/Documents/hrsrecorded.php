          ...
          <div class="row justify-content-center mt-50">
              <div class="col-lg-8">
                  <div class="section-title text-center pb-25">
                      ...
                      <p>Your hours have been recorded in our database. If you need to record your hours through an external platform, you can use the email support@scholastician.org to verify your hours. Please feel free to email us if you have any questions. </p>
                  </div> <!-- section title -->
              </div>
          </div> <!-- row -->
      </div> <!-- container -->
