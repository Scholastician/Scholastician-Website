            ...
            <div class="row justify-content-center mt-50">
                <div class="col-lg-8">
                    <div class="section-title text-center pb-25">
                        <h2 class="title">Volunteer Hours</h2>
                ...
                <div class="col-lg-8">
                    <div class="contact-form pt-30">
                      <?php if (isset($name_error)) {
                        ...
                        <form id="contact-form" action="hrs.php" onsubmit="">

                            <h5 class="about-title">How many hours did you tutor?</h5>
                            <br>
                            <p>Please record the number of hours you have tutored your latest student. If you have tutored multiple students recently, please fill out the form multiple times, once per student you have tutored. Lastly, please be honest about your hours, and we may verify your hours with your students if we suspect any untruthful recording of hours.
                            </p>

                            <br>
                            <select  class = "select-css" name="hrs-select" required>
